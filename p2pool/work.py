...
class WorkerBridge(worker_interface.WorkerBridge):
    ...
    def get_work(self, pubkey_hash, desired_share_target, desired_pseudoshare_target):
        ...
        ba = dict(
            ...
            coinb1=packed_gentx[:-self.COINBASE_NONCE_LENGTH-8], #counted in refheight into the packed "gentx"
            coinb2=packed_gentx[-8:], #counted in refheight into the packed "gentx"
